...
local _iris_Internal = (function()
    ...
    return function(Iris: Types.Iris): Types.Internal
        ...
        function Internal._NoOp() end
            ...
            @param type string 
            @param widgetClass Types.WidgetClass 
        ...
        function Internal.WidgetConstructor(type: string, widgetClass: Types.WidgetClass)
            ...
            @param states { [string]: States<any> }? 
            @return Widget 
...
local _iris_widgets_Window = (function()
    ...
    return function(Iris: Types.Internal, widgets: Types.WidgetUtility)
        ...
        local dragWindow: Types.Window? 
        local isDragging = false
        local moveDeltaCursorPosition: Vector2 
        local resizeWindow: Types.Window? 
        ...
        local focusedWindow: Types.Window? 
        local anyFocusedWindow = false 
        local windowWidgets: { [Types.ID]: Types.Window } = {} 
        ...
        Iris.WidgetConstructor("Window", {
            ...
            UpdateState = function(thisWidget: Types.Window)
                ...
                if stateIsUncollapsed then
                    ...
                    local collapsedHeight: number = TitleBar.AbsoluteSize.Y 
...
local _iris_widgets_init = (function()
    ...
    return function(Iris: Types.Internal)
        ...
        function widgets.getScreenSizeForWindow(thisWidget: Types.Widget) 
...
local _iris_init = (function()
    ...
    Iris.Events = {}
        ...
        @param eventConnection (RBXScriptSignal | () -> () | false)? 
        @param allowMultipleInits boolean? 
        @return Iris
    ...
    function Iris.VariableState<T>(variable: T, callback: (T) -> ())
        ...
        @param table { [K]: V } 
        @param key K 
        @param callback ((newValue: V) -> false?)? 
        @return State<V>
        @tag State
    ...
    function Iris.TableState<K, V>(tab: { [K]: V }, key: K, callback: ((newValue: V) -> true?)?)
        ...
        @param firstState State<T> 
        @param onChangeCallback (firstValue: T) -> U 
        @return State<U>
